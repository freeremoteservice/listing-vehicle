  ...
  <div class="container">
    <div class="d-flex flex-column justify-content-center align-items-center">
      <nav aria-label="breadcrumb">
        <h2 class="breadcrumb-title text-center mb-4">Privacy Policy</h2>
...
<section class="py-7 py-md-10">
  <div class="container">
    ...
    <div class="py-6">
        <h3 class="h4">Wie erfassen wir Ihre Daten?</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Welche Rechte haben Sie bezüglich Ihrer Daten?</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Hinweis zur verantwortlichen Stelle</h3>
        <p class="mb-0">
            Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
            <br /><br />
            <strong>Anbieterkennzeichnung gemäß § 5 TMG:</strong>
            <br /><br />
            <strong>IVG Industrie-Verwertungs-Gesellschaft mbH & Co. KG</strong>
            <br />
            Dipl.-Ing. Hubert Küpers – Auktionator
            Felix-Wankel-Str. 2
            32278 Kirchlengern
            Deutschland
            <br /><br />
            T +49 52 23 / 65 32 00
            F +49 52 23 / 65 32 010
            E <a href="mailto:<?= WEBSITE_EMAIL; ?>"><?= WEBSITE_EMAIL; ?></a>
            <br /><br />
    ...
    <div class="py-6">
        <h3 class="h4">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">SSL- bzw. TLS-Verschlüsselung</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Widerspruch gegen Werbe-Mails</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Server-Log-Dateien</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Google reCaptcha</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        ...
        <p class="mb-0">
            ...
            <br /><br />
            Weitere Informationen zum Umgang von Nutzerdaten finden Sie in der Datenschutzerklärung von YouTube unter: <a href="https://www.google.de/intl/de/policies/privacy">https://www.google.de/intl/de/policies/privacy</a>
        </p>
    </div>
    <div class="py-6">
        <h3 class="h4">Kommentarfunktion auf dieser Webseite</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        <h3 class="h4">Rechtsgrundlage</h3>
        <p class="mb-0">
    ...
    <div class="py-6">
        ...
        <p class="mb-0">
            ...
            <br /><br />
            Wir haben mit Facebook eine Vereinbarung über eine gemeinsame Verantwortlichkeit bei der Verarbeitung von Daten (Controller Addendum) geschlossen. In dieser Vereinbarung wird festgelegt, für welche Datenverarbeitungsvorgänge wir bzw. Facebook verantwortlich ist, wenn Sie unsere Facebook- Fanpage besuchen. Diese Vereinbarung können Sie unter folgendem Link einsehen: <a href="https://www.facebook.com/legal/terms/page_controller_addendum">https://www.facebook.com/legal/terms/page_controller_addendum</a>
            <br /><br />
